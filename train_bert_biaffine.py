...
from model.finetune_biaffine import FineTune_Biaffine
...
from utils.utils import collate_fn_cuda, collate_fn
...
if __name__ == '__main__':
    ...
    train_data = BertDataSet_Biaffine(bert_vocab_path=args.bert_path+'/',
                                      corpus=train_samples.samples,
                                      label_vocab=label_vocab)
    dev_data = BertDataSet_Biaffine(bert_vocab_path=args.bert_path+'/',
                                      corpus=dev_samples.samples,
                                      label_vocab=label_vocab)
    test_data = BertDataSet_Biaffine(bert_vocab_path=args.bert_path+'/',
