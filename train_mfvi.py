...
from model.bilstm_mfvi import BiLSTM_MFVI
...
if __name__ == '__main__':
    ...
    # mfvi related
    parser.add_argument('--mfvi_window_size', default=1, type=int)
    parser.add_argument('--mfvi_iterations', default=3, type=int)
    parser.add_argument('--mfvi_add_start_end', action="store_true")
