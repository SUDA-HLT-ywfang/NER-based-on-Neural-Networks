...
class Input_Data():
    def __init__(self,word_emb_num,word_emb_dim,common_hidden_dim,private_hidden_dim,dropout,lstm_layers,use_cuda,pretrain_wordemb,word_vocab,
                 char_vocab, batchsize, source_label_vocab, target_label_vocab,
                 pretrain_charemb=None,use_char=False,char_model='CNN', feature_config=()):
        self.word_emb_num = word_emb_num
        self.word_emb_dim = word_emb_dim
        self.common_hidden_dim = common_hidden_dim
        self.private_hidden_dim = private_hidden_dim
        self.dropout = dropout
        self.lstm_layers = lstm_layers
        self.source_label_vocab = source_label_vocab
        self.source_label_size = source_label_vocab.get_size()
        self.target_label_vocab = target_label_vocab
        self.target_label_size = target_label_vocab.get_size()
        self.gpu = use_cuda
    ...
    def show_setup_all(self):
        ...
        print("common  lstm hidden dim:", self.common_hidden_dim)
        print("private lstm hidden dim:", self.private_hidden_dim)
        ...
        print("Source Label vocab size:", self.source_label_size)
        print("Target Label vocab size:", self.target_label_size)
