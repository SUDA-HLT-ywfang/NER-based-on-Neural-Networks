...
from model.bilstm_biaffine import BiLSTM_Biaffine
...
from utils.utils import instance2tensor_for_biaffine, collate_fn_cuda, collate_fn
...
if __name__ == '__main__':
    ...
    train_data = instance2tensor_for_biaffine(train_samples.samples, word_vocab, char_vocab, label_vocab)
    dev_data = instance2tensor_for_biaffine(dev_samples.samples, word_vocab, char_vocab, label_vocab)
    test_data = instance2tensor_for_biaffine(test_samples.samples, word_vocab, char_vocab, label_vocab)
